...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Kavya Theme Options', 'optionsframework'),
		'menu_title' => __('Kavya Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'Kavya-options',
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Kavya Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=Kavya-options' )
		));
}
