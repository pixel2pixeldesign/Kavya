  ...
  <header id="masthead" class="site-header" role="banner">
    <div class="header-wrapper">
      <div class="site-branding">
        <?php 
            if ( of_get_option( 'custom_logo', false ) ) { ?>
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php bloginfo( 'description' ); ?>" > <img src="<?php echo esc_url(of_get_option('custom_logo', true)); ?>"> </a>
        <?php }
			else { ?>
      ...
      <div id="social-icons">
        <?php if ( of_get_option( 'facebook', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'twitter', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'google', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'youtube', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'pinterest', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'instagram', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'linkedin', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'flickr', false ) ) { ?>
        ...
        <?php } ?>
        <?php if ( of_get_option( 'dribble', false ) ) { ?>
